...
return [
    ...
    'listen_port'              => env('LARAVELS_LISTEN_PORT', 5255),
...
//        Tymon\JWTAuth\Providers\LaravelServiceProvider::class,
    ...
    'cleaners'                 => [
        ...
        \App\Cleaners\AdminCleaner::class
        // ...
    ],
    'destroy_controllers'      => [
        'enable'        => true,
        'excluded_list' => [
            \Encore\Admin\Controllers\AdminController::class,
            \Encore\Admin\Controllers\HandleController::class,
        ],
    ],
    'swoole'                   => [
