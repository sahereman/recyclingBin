...
class FullFabricsController extends AdminController
{
    /**
     * Title for current resource.
     * @var string
     */
    protected $title = '纺织物-满箱预警';
    ...
    {
        $grid = new Grid(new BinTypeFabric);
        ...
        $grid->model()->where('status', BinTypeFabric::STATUS_FULL)->with('bin')->orderBy('number', 'desc'); // 设置初始排序条件
    ...
    {
        $show = new Show(BinTypeFabric::findOrFail($id));
    ...
    {
        $form = new Form(new BinTypeFabric);
